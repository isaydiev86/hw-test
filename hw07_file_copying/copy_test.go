...
func TestCopy(t *testing.T) {
	var (
		...
		cf = equalfile.New(nil, equalfile.Options{})
	)
	...
	t.Run("copy offset = 0; limit = 0", func(t *testing.T) {
		...
		equal, err := cf.CompareFile(outputFile, "testdata/out_offset0_limit0.txt")
		require.NoError(t, err)
	...
	t.Run("copy offset = 0; limit = 10", func(t *testing.T) {
		...
		equal, err := cf.CompareFile(outputFile, "testdata/out_offset0_limit10.txt")
		require.NoError(t, err)
		require.True(t, equal)
	...
	t.Run("copy offset = 0; limit = 1000", func(t *testing.T) {
		err := Copy(inputFile, outputFile, 0, 1000)
		require.NoError(t, err)

		equal, err := cf.CompareFile(outputFile, "testdata/out_offset0_limit1000.txt")
		require.NoError(t, err)
		require.True(t, equal)
	...
	t.Run("copy offset = 0; limit = 10'000", func(t *testing.T) {
		err := Copy(inputFile, outputFile, 0, 10_000)
		require.NoError(t, err)

		equal, err := cf.CompareFile(outputFile, "testdata/out_offset0_limit10000.txt")
		require.NoError(t, err)
		require.True(t, equal)
	...
	t.Run("copy offset 100; limit 1000", func(t *testing.T) {
		...
		require.NoError(t, err)
		equal, err := cf.CompareFile(outputFile, "testdata/out_offset100_limit1000.txt")
		require.NoError(t, err)
		require.True(t, equal)
	...
	t.Run("copy offset = 6000; limit = 1000", func(t *testing.T) {
		...
		equal, err := cf.CompareFile(outputFile, "testdata/out_offset6000_limit1000.txt")
		require.NoError(t, err)
		require.True(t, equal)
	...
	t.Run("copy offset exceeds file size", func(t *testing.T) {
